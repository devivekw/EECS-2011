...
public class LinkedBinaryTree implements BinaryTree {
  ...
  public Position insertLeft(Position v, Object e) throws InvalidPositionException {
    if (hasLeft(v))
  ...
  public Position insertRight(Position v, Object e) throws InvalidPositionException {
    if (hasRight(v))
  ...
  public void attach(Position v, BinaryTree T1, BinaryTree T2) throws InvalidPositionException {
    if (isInternal(v))
   ...
   */
  public void expandExternal(Position v, Object l, Object r) throws InvalidPositionException {
    if (!isExternal(v))
   ...
   */
  public void removeAboveExternal(Position v) throws InvalidPositionException {
    if (!isExternal(v))
      throw new InvalidPositionException("Node is not external");
    if (isRoot(v))
      remove(v);
